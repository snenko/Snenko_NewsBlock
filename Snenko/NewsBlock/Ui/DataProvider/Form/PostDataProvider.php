 ...
 */
namespace Snenko\TagSlider\Ui\DataProvider\TagSlider\Form;

use Snenko\TagSlider\Model\ResourceModel\Tagslider\CollectionFactory;
...
class PostDataProvider extends \Magento\Ui\DataProvider\AbstractDataProvider
{
    ...
    public function getData()
    {
        ...
        $data = $this->dataPersistor->get('tagslider_relatedproduct_form_data');
        if (!empty($data)) {
            $post = $this->collection->getNewEmptyItem();
            $post->setData($data);
            $this->loadedData[$post->getId()] = $post->getData();
            $this->dataPersistor->clear('tagslider_relatedproduct_form_data');
        }
